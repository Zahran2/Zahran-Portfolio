...
const commands = {
    ...
    about: "Lulusan D4 Teknik Informatika Politeknik Negeri Bandung (Polban). Memiliki pengalaman profesional sebagai Fullstack Developer di PT Someah Kreatif Nusantara selama 5 bulan. Terbiasa membangun aplikasi web secara komprehensif, memiliki ketertarikan mendalam pada eksplorasi berbagai bidang IT, serta gemar menuangkan kreativitas ke dalam pengembangan game.",
    ...
    projects: "Fetching projects repository...\n[=========================> ] 85%\n\nCurrently compiling and organizing detailed documentation for:\n> /web-and-enterprise-systems (Internship & Fullstack)\n> /data-science-and-ai (Computer Vision & Data Prep)\n> /automation-and-rpa (Thesis Project)\n> /desktop-and-mobile-apps\n> /game-development\n\n[System Message]: Project database is currently being updated. Please check back soon or use the 'contact' command to reach out directly!",
